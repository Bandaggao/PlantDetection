...
public class MultiBoxTracker {
  ...
  private static float detectionConfidenceScore;
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      if (getFrameToCanvasMatrix().mapRect(trackedPos)) {
        labelString = String.format("%.2f", trackedObject.getCurrentCorrelation());
        kuhaName = labelString;
        detectionConfidenceScore = recognition.detectionConfidence;
        getConfidenceScore = detectionConfidenceScore;
...
//
//  public static String kuhaName(String labelString) {
//    return labelString;
//  }
//public static String kuhaName() {
//
...
//
//    return detectionConfidenceScore;
//  }
